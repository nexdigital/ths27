<div class="toolbar">
	<div class="btn-group" role="group">
	  <button type="button" class="btn btn-default" onCLick="setPage('<?php echo base_url('master/bank/index_bank_branch') ?>')" style="height:34px;"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></button>
